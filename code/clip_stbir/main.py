...
if __name__ == '__main__':
    ...
    # Our Dataset
    train_dataset = CustomSketchyCOCO(opts, img_preprocess=img_preprocess, mode='train', use_coco=True)
    val_dataset = CustomSketchyCOCO(opts, img_preprocess=img_preprocess, mode='val', use_coco=True)
